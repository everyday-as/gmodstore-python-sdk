...
class AddonDownload(object):
    ...
    def __init__(self, url=None, local_vars_configuration=None):  # noqa: E501
        """AddonDownload - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def url(self):
        """Gets the url of this AddonDownload.  # noqa: E501


        :return: The url of this AddonDownload.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this AddonDownload.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddonDownload):
            return False
