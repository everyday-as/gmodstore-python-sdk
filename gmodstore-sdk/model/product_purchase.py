...
class ProductPurchase(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, user_id, product_id, revoked, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, user_id, product_id, revoked, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """ProductPurchase - a model defined in OpenAPI
