...
class DownloadProductVersionResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (DownloadProductVersionResponseData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """DownloadProductVersionResponse - a model defined in OpenAPI

        Args:
            data (DownloadProductVersionResponseData):
