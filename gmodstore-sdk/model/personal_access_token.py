...
def lazy_import():
    ...
    globals()['PersonalAccessTokenScope'] = PersonalAccessTokenScope
...
class PersonalAccessToken(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'abilities': ([PersonalAccessTokenScope],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, abilities, last_used_at, expires_at, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """PersonalAccessToken - a model defined in OpenAPI

        Args:
            id (str):
            name (str):
            abilities ([PersonalAccessTokenScope]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, abilities, last_used_at, expires_at, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """PersonalAccessToken - a model defined in OpenAPI
