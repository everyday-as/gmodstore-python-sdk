...
class NewPermissionGroupPayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, permissions, *args, **kwargs):  # noqa: E501
        """NewPermissionGroupPayload - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, permissions, *args, **kwargs):  # noqa: E501
        """NewPermissionGroupPayload - a model defined in OpenAPI
