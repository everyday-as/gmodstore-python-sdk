...
class UserBadge(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, description, extension, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, description, extension, *args, **kwargs):  # noqa: E501
        """UserBadge - a model defined in OpenAPI
