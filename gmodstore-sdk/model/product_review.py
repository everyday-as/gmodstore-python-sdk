...
def lazy_import():
    ...
    globals()['ProductReviewVotes'] = ProductReviewVotes


class ProductReview(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'votes': (ProductReviewVotes,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, user_id, title, body, rating, version, votes, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, user_id, title, body, rating, version, votes, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """ProductReview - a model defined in OpenAPI
