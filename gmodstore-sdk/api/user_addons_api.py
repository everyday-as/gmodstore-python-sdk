...
class UserAddonsApi(object):
    ...
    def list_user_addons(self, user_id, **kwargs):  # noqa: E501
        ...
        :type user_id: int
        :param _with: The relations you want to fetch with the `Addon`
        :type _with: list[str]
    ...
    def list_user_addons_with_http_info(self, user_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('user_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `user_id` when calling `list_user_addons`")  # noqa: E501
