...
class UserAddonsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_user_addons_endpoint = _Endpoint(
            settings={
                'response_type': (AddonListResponse,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/users/{user_id}/addons',
                'operation_id': 'list_user_addons',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def list_user_addons(
        ...
        **kwargs
        ...
        kwargs['user_id'] = \
            user_id
        return self.list_user_addons_endpoint.call_with_http_info(**kwargs)
