...
class UserProductsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_user_products_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'PersonalAccessToken'
                ],
                'endpoint_path': '/api/v3/users/{user}/products',
                'operation_id': 'list_user_products',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def list_user_products(
        ...
        **kwargs
        ...
        >>> thread = api.list_user_products(user, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['user'] = \
            user
        return self.list_user_products_endpoint.call_with_http_info(**kwargs)
