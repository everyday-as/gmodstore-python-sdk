...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AddonCouponsApi()
        api_instance.create_addon_coupon  # this is an instance of the class Endpoint
        api_instance.create_addon_coupon()  # this invokes api_instance.create_addon_coupon.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_addon_coupon.callable or self.callable in this class
