...
from gmodstore-sdk import rest
from gmodstore-sdk.configuration import Configuration
from gmodstore-sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from gmodstore-sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = PermissionGroupsApi()
        api_instance.create_permission_group  # this is an instance of the class Endpoint
        api_instance.create_permission_group()  # this invokes api_instance.create_permission_group.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_permission_group.callable or self.callable in this class
