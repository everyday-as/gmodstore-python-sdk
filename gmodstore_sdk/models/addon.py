...
class Addon(object):
    ...
    def __init__(self, id=None, active=None, name=None, short_description=None, description=None, requirements=None, price=None, images=None, slug=None, route=None, created_at=None, updated_at=None, latest_version=None, team=None):  # noqa: E501
