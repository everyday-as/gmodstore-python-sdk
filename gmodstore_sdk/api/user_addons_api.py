...
class UserAddonsApi(object):
    ...
    def list_user_addons(self, user_id, **kwargs):  # noqa: E501
        """Fetch all the addons authored / co-authored by a user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_user_addons(user_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.list_user_addons_with_http_info(user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.list_user_addons_with_http_info(user_id, **kwargs)  # noqa: E501
            return data

    def list_user_addons_with_http_info(self, user_id, **kwargs):  # noqa: E501
        """Fetch all the addons authored / co-authored by a user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_user_addons_with_http_info(user_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method list_user_addons" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('user_id' not in params or
            ...
            raise ValueError("Missing the required parameter `user_id` when calling `list_user_addons`")  # noqa: E501
